...
const SendTransfer = () => {
  ...
  useEffect(() => {
    ...
    if (rate && formData.amount) {
      setCurrentRate(rate.sell_rate);
      setConvertedAmount(parseFloat(formData.amount) * rate.sell_rate);
    } else {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.amount || !formData.recipientName || !formData.recipientPhone) {
      toast({
        title: "خطا",
    ...
    if (error) {
      toast({
        title: "خطا",
        description: "مشکلی در ثبت حواله رخ داد",
        variant: "destructive",
      });
    } else {
      toast({
        title: "موفق",
        description: "حواله با موفقیت ثبت شد",
      });
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <Card className="border-border/50 bg-card/80 backdrop-blur-xl">
            <CardHeader className="text-center">
              ...
              <CardDescription>ارسال پول به گیرنده با بهترین نرخ</CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  {convertedAmount > 0 && (
                    <p className="text-sm text-muted-foreground">
                      معادل: <span className="text-primary font-mono">{convertedAmount.toFixed(2)} {formData.toCurrency}</span>
                      {" | "}
                ...
                <div className="border-t border-border/50 pt-6">
                  <h3 className="font-semibold mb-4">اطلاعات گیرنده</h3>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <Label>شماره حساب گیرنده</Label>
                      <Input
                        placeholder="شماره حساب یا کارت (اختیاری)"
